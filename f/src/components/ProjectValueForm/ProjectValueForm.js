...
export default () => {
    ...
    const fields = [
        ...
        ['10. MARKET GROWTH'],
        ["11. rate", "20% or greater", "less than 20%"],
        ["PRICE/ FREQUENCY/ VALUE"],
        ["12. price", "gross margin > 40%", "gross margin greater than 40%"],
        ["13. frequency", "often and repeated", "one time"],
        ["14. value", "fully reflected in price", "penetration pricing"],
        ["15. operating expenses", "low and variable", "large and fixed"],
        ["16. net profit margin", "greater than 10%", "lesser than 10%"],
        ["17. volume", "very high", "moderate"],
        ['DISTRIBUTION'],
        ["18. where are you in value chain", "high margin, high power", "low margin, low power"],
        ["COMPETITION"],
        ["19. market structure", "emerging", "mature"],
        ["20. number of direct competitors", "few", "many"],
        ["21. number of indirect competitors", "few", "many"],
        ["22. number of substitutes", "few", "many"],
        ["23. steath competitors", "unlikely", "likely"],
        ["24. strength of competitors", "weak", "strong"],
        ['KEY SUCCESS FACTORS'],
        ["25. relative position", "strong", "weak"],
        ['VENDORS'],
        ["26. relative power", "weak", "strong"],
        ["27. gross margins they control in value chain", "low", "high"],
        ['GOVERNMENT'],
        ["28. regulations", "low", "high"],
        ["29. taxes", "low", "high"],
        ['30. GLOBAL ENVIRONMENT'],
        ["31. customers", "interested and accessible", "not interested or accessible"],
        ["32. competitors", "nonexistent or weak", "existing and strong"],
        ["33. vendors", "eager", "unavaliable"]
    ]
